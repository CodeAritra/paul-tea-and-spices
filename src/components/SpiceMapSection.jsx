...
export default function SpiceMapSection({ lang = "de" }) {
  ...
  useEffect(() => {
    let isMounted = true;
    const wikimediaUrl =
      "https://upload.wikimedia.org/wikipedia/commons/b/b4/India_outline.svg";
  ...
  const handleNextSpice = () => {
    ...
    const currentIndex = SPICES_DATA.findIndex(
      (s) => s.id === selectedSpice.id,
    );
  ...
  const handlePrevSpice = () => {
    ...
    const prevIndex =
      (currentIndex - 1 + SPICES_DATA.length) % SPICES_DATA.length;
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          >
            ...
            >
              ...
              <div className="absolute top-4 right-4 z-10 pointer-events-none flex flex-col items-center">
                <div className="relative w-12 h-12 rounded-full border border-[#C5A059]/60 bg-white/80 backdrop-blur-sm flex items-center justify-center shadow-md">
                  ...
                  >
                    ...
                    <polygon
                      points="20,36 23,20 20,22"
                      fill="#C5A059"
                      opacity="0.3"
                    />
                    <polygon
                      points="20,36 17,20 20,22"
                      fill="#121D2C"
                      opacity="0.3"
                    />
